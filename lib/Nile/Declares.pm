# original module Method::Signatures::Simple
package Nile::Declares;
{
  $Nile::Declare::VERSION = '1.0';
}
...
Nile::Declare - Basic method declarations with signatures, without source filters
